...
<div class="container">
    <form action="" method="post">
        <h2 style="text-shadow: 0px 0px 2px #717171;">Envío de correos masivos</h2>
    <hr>
    <br><br>
<div style="text-align:center;">
    <button type="submit" class="btn btn-primary btn-sm" name="send"><i class="fas fa-paper-plane"></i> Enviar correos</button>
</div>
    <br><br>
