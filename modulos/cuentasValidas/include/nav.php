...
<br> 
 <nav class="navbar navbar-expand-lg navbar-light">
   <a href="selectSistem.php"><img src="../img/logoImplementtaHorizontal.png" width="250" height="82" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="nav-item nav-link" href="selectSistem.php"> Inicio </a>

        <a class="nav-item nav-link" href="../Administrador/config.php"> <i class="fas fa-users-cog"></i> Administrador </a>
