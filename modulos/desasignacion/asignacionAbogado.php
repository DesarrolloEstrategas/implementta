...
//$cnx = $connection("implementta.mx", $conn_name);
...
if (isset($_POST['update'])) {
    $idAsp=$_POST['idasp'];
    $storedQuery = "update AsignacionAbogado set IdAspUser = '00000000000000000000' where IdAspUser = '$idAsp'";
...
//        echo '<meta http-equiv="refresh" content="0,url=asignacionAbogado.php?rol='.$_GET['rol'].'&plz='.$_GET['plz'].'&name='.$_GET['name'].'">';
//    } else {
        ...
        <table class="table table-hover table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;"><?php  $cuenta = "select Count(AsignacionAbogado.Cuenta) from asignacionabogado
