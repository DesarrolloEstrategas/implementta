...
<br> 
 <nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <?php } else{ ?>
        <a class="nav-item nav-link" href="updateProfile.php">| <i class="fas fa-user-cog"></i> Configuracion |</a>
    <?php } ?>
<!--        <a class="nav-item nav-link" href="#">| Cargar Base |</a>-->
        <a class="nav-item nav-link" href="#info">| Informacion <i class="fa fa-info"></i>|</a>
        <a class="nav-item nav-link" href="#ubicacion">| Ubicacion <i class="fa fa-map-marker"></i>|</a>
        <a class="nav-item nav-link" href="#fotos">| Fotos <i class="fa-camera-retro"></i>|</a>
        <a class="nav-item nav-link" href="#tareas">| Tareas <i class="far fa-edit"></i>|</a>
        <a class="nav-item nav-link" href="#gestiones">| Comentarios <i class="fa fa-commenting-o"></i>|</a>
        <a class="nav-item nav-link" href="#legal">| RPPYP <i class="fa fa-university"></i>|</a>
        <a class="nav-item nav-link" href="">| Expediente <i class="fa fa-map-marker"></i>|</a>
<!--
